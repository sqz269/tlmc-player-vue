import { LyricsLineDto, LyricsReadDto, LyricsTextDto, LyricsVariantDto, RubyDto } from "app/backend-service-api/src";
...
export class Ruby
{
  ...
  public static fromRubyDto(rubyDto: RubyDto) 
  {
...
export class LyricsText
{
  ...
  public static fromLyricsTextDto(lyricsTextDto: LyricsTextDto) 
  {
...
export class LyricsLine 
{
  ...
  public static fromLyricsLineDto(lyricsLineDto: LyricsLineDto) 
  {
...
export class LyricsVariant 
{
  ...
  public static fromLyricsVariantDto(lyricsVariantDto: LyricsVariantDto) 
  {
...
export class Lyrics 
{
  ...
  public static fromLyricsDto(lyricsDto: LyricsReadDto) 
  {
